...
public class ExpenseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("ExpenseDatabase").child(uid);

        expense_result = view.findViewById(R.id.expense_txt_result);
    ...
    private void fetchData(){
        ValueEventListener valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                expense_result.setText(totalAmount);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Log.d("ExpenseFragment", databaseError.getMessage());
            }
        };
